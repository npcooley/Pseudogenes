universe = vanilla
executable = OSGWrapperB.sh
log = LogFilesB/out.$(v01).log
...
transfer_input_files = JobScriptB.R

# If just has been running for more than x hours - 3600 seconds to an hour! - put it on hold
periodic_hold = (JobStatus == 2) && ((CurrentTime - EnteredCurrentStatus) > 21600)
...
queue v01, v02, v03, v04, v05, v06, v07, v08, v09, v10 from TestMapB.txt
