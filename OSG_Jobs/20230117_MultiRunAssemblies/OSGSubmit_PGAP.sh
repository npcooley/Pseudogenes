universe = vanilla
executable = OSGWrapper_PGAP.sh
log = LogFiles_PGAP/out.$(v01).log
# PGAP err and output files are too large to collect at scale once this
# job is debugged
# output = LogFiles_PGAP/out.$(v01).log
# error = LogFiles_PGAP/out.$(v01).log
output = LogFiles_PGAP/out.a.out
error = LogFiles_PGAP/out.a.err
...
queue v01, v02, v03, v04, v05, v06 from TestMap_PGAP.txt
